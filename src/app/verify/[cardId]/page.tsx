...
function StatBar({
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 h-[5px] rounded-full neu-bar-track overflow-hidden">
        <motion.div
      ...
      <div className="max-w-[600px] mx-auto px-5 py-16 sm:py-24">
        ...
        >
          ...
          <div className="flex items-center gap-2.5">
            <span
              className="text-[11px] font-mono font-semibold uppercase tracking-wider px-2.5 py-1 rounded neu-badge"
              style={{
        ...
        {/* Divider */}
        <div className="neu-divider mb-10" />
        ...
        >
          ...
          <div className="rounded-lg neu-raised">
        ...
        >
          ...
          <button
            onClick={copyUrl}
            className="inline-flex items-center justify-center gap-2 rounded-lg neu-btn text-text-primary px-5 py-2.5 text-[13px] font-medium"
          >
            {copied ? (
              <>
        ...
        {/* Footer */}
        <div className="mt-16 pt-6 neu-divider">
