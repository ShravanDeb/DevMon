    ...
    <main ref={containerRef} className="min-h-screen flex flex-col">
      ...
      >
        ...
        >
          ...
          {/* CTA */}
          <motion.div variants={variants.fadeUp} className="mt-12 flex items-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-[14px] font-medium border border-border-primary bg-transparent text-text-secondary hover:text-text-primary hover:border-border-secondary transition-all duration-200"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
