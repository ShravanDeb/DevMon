        ...
        >
          ...
          <motion.div variants={variants.fadeUp} className="mt-12 flex items-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-[6px] px-5 py-2.5 text-[13px] leading-none font-medium border border-border-primary bg-[#1B1B1F] text-text-primary hover:border-border-secondary transition-colors"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
